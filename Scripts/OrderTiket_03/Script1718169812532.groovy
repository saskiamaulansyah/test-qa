...
WebUI.setText(findTestObject('Object Repository/Page_Beli/input_Data Pemesan_name'), 'test2013')

WebUI.setText(findTestObject('Object Repository/Page_Beli/input__phone'), '081123456789')

WebUI.setText(findTestObject('Object Repository/Page_Beli/input__email'), 'test2013@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Beli/p_Pesanan Sudah Ada'), 
    0)

WebUI.waitForElementPresent(findTestObject('Page_Beli/p_Pesanan Sudah Ada'), 10)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Page_Beli/button_Ok, Terima Kasih'))

WebUI.click(findTestObject('Object Repository/Page_Beli/button_Cancel'))
